...
//currentprojection = perspective((2, 2,2)); // sfera 100 toro 010 , up = (1,1,0)
currentprojection = perspective((5, 5, 5),up = (0,1,0));
...
/*
triple origin = nurbs_edges[0]; // bottom-left corner of the merged surface
