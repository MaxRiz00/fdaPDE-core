...
pen boundaryEdgePen = gray  + 1.2bp;
...
/*
draw(origin -- (origin + (axisLength,0,0)), Arrow3(6bp)); label("$x$", origin + (axisLength+0.1,0,0),fontsize(6pt));
draw(origin -- (origin + (0,axisLength,0)), Arrow3(6bp)); label("$y$", origin + (0,axisLength+0.1,0),fontsize(6pt));
draw(origin -- (origin + (0,0,axisLength)), Arrow3(6bp)); label("$z$", origin + (0,0,axisLength+0.1),fontsize(6pt));
...
triple[] U = {
  (-2.7, 8.52, -0.0396),
  (-1.2, 8.89269, -0.631174),
  (-1.2, 9.12441, -0.858934),
  (-1.2, 9.22421, -0.92394)
};
