...
- `fdaPDE/src/fields`: contains the implementation of the `spline.h` and `nurbs.h`, which implements single B-Spline and NURBS fields, respectively. 
- `fdaPDE/src/splines`: contains the implememntation of Spline utilities.
...
## Documentation
The official documentation of fdaPDE, still under developement, can be found on [documentation site](https://fdapde.github.io/).
...
- **Library tests**
  ...
  ./run_tests.sh
  ```
  Note that maybe the compiler should be set properly in the CMake file if you are not using the default one. 
- **Simulations**
    ...
    * sphere_biharmonic,
    ...
    To visualize plots, execute the following command in the simulation folder. With `asymptote`, we generate three kind of plots: the computational geometry, the solution, and the error. All plots are saved as high-quality `.png` files. Here an example on how to plot the results once the simulation is completed:
...
### 🌐 Sphere Domain
<div align="center">
  <img src="simulations/sphere_diff/plot_mesh.png" alt="Sphere Mesh" width="300" style="margin: 10px;"/>
  <img src="simulations/sphere_diff/plot_solution.png" alt="Sphere Solution" width="300" style="margin: 10px;"/>
</div>

### 🌀 Torus Domain
<div align="center">
  <img src="simulations/torus_diff/plot_mesh.png" alt="Torus Mesh" width="300" style="margin: 10px;"/>
  <img src="simulations/torus_diff/plot_solution.png" alt="Torus Solution" width="300" style="margin: 10px;"/>
</div>